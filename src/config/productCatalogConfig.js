...
export const SUBCATEGORY_OPTIONS = {
  ...
  dupattas: ["Dupatta", "Stole", "Handbag", "Clutch", "Sunglasses"],
  bangles: ["Bridal Bangles", "Gold-finish Bangles", "Kada + Cuffs"],
  jewellery: ["Earrings", "Necklaces", "Bracelets", "Rings", "Maang Tikka", "Jewellery Set"],
  menswear: [
    "Kurta",
    "Kurta Pajama",
    "Sherwani",
